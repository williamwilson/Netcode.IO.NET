...
namespace Org.BouncyCastle.Bcpg
{
    ...
    */
        ...
        : BaseOutputStream
    {
        ...
        private static readonly string Version = "BCPG C# v" + typeof(RuntimeEnvironment).GetTypeInfo().Assembly.GetCustomAttribute<AssemblyFileVersionAttribute>().Version;
